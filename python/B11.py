...
(here identified by the column and row identifiers).
 ...
 *1 32 98 81 28 64 23 67 10 26 38 40 67 59 54 70 66 18 38 64 70
 *2 67 26 20 68 02 62 12 20 95 63 94 39 63 08 40 91 66 49 94 21
 *3 24 55 58 05 66 73 99 26 97 17 78 78 96 83 14 88 34 89 63 72
 *4 21 36 23 09 75 00 76 44 20 45 35 14 00 61 33 97 34 31 33 95
...
def scan(filename, count):
    ...
    the matrix of numbers from the given file.
    ...
    with open(os.path.join(os.path.dirname(__file__), filename)) as grid_data:
        grid = [[int(x) for x in line.split()] for line in grid_data.readlines()]
